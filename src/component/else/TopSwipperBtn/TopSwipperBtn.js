        ...
        return (
            <div className="flex items-center pb-3">
                ...
                <div className="ml-auto flex items-center">
                    <button id='my-btn' className=" rounded text-[24px] focus:outline-none bg-fill-4 dark:bg-dark-fill-4 hover:bg-fill-3 dark:hover:bg-dark-fill-3 active:text-label-3 dark:active:text-dark-label-3 text-label-2 dark:text-dark-label-2" aria-label="Prev">
                    ...
                    <button id='my-btn' className="rounded text-[24px] focus:outline-none bg-fill-4 dark:bg-dark-fill-4 hover:bg-fill-3 dark:hover:bg-dark-fill-3 active:text-label-3 dark:active:text-dark-label-3 text-label-2 dark:text-dark-label-2 ml-1.5" aria-label="Next">
